...
describe('Tw Gutter', () => {
  ...
  it('should add inline block class when its required by "inlineBlock" prop', () => {
    ...
    expect(wrapper.classes()).toContain('tw-u_display--inline-block');
  });
